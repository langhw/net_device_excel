...
class FwRules_To_Excle(object):
    def __init__(self, dev_info):
        ...
        self.log = r'C:\Users\lianghw\Desktop\LOG\JG'
    ...
    def write_excel(self):
        ...
        print('-' * 50)
        print('>>>>表格写入已经执行完成，总共耗时{:0.2f}秒.<<<'.format((end_time - start_time).total_seconds()))


if __name__ == '__main__':
    FwRules_To_Excle().write_excel()
